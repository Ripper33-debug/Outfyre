    ...
    <section id="pricing" className="section-padding bg-charcoal relative">
      <div className="relative max-w-6xl mx-auto">
        <ScrollReveal className="mb-16 text-center">
          <p className="label-mono text-ember mb-4">Pricing</p>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-cream mb-4 tracking-tight">
            Monthly retainers. No surprises.
          </h2>
          <p className="text-muted max-w-xl mx-auto">
            Every tier is a recurring partnership — we build, run, and optimize
            your AI systems month over month.
          </p>
        </ScrollReveal>
            ...
            <StaggerItem key={tier.name}>
              <motion.div
                ...
                whileHover={
                  reducedMotion
                    ? undefined
                    : { y: -6, borderColor: "rgba(255, 106, 61, 0.35)" }
                }
